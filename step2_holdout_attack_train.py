#!/usr/bin/env python3
"""
step2_holdout_attack_train.py

Train a packet-level binary classifier under a stricter holdout-attack setting.

Default experimental design:
- Train/validation uses:
  - first 50% of normal traffic
  - all packets from train attack types: flood, malformed
- Test uses:
  - remaining 50% of normal traffic
  - all packets from test attack types: invalid_teid, spoofing
